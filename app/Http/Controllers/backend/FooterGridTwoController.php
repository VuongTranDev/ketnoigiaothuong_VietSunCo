...
class FooterGridTwoController extends Controller
{
    ...
    public function index(FooterGridTwoDataTables $dataTable)
    {
        ...
        return $dataTable->render('frontend.admin.footer.footer-grid-two.index', compact('footerTitle'));
    }
    ...
    {
        return view('frontend.admin.footer.footer-grid-two.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.footer-grid-two.index')->with('success', 'Thêm thành công!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.admin.footer.footer-grid-two.edit', compact('footer'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.footer-grid-two.index')->with('success', 'Cập nhật thành công!');
    }
