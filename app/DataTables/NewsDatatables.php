...
class NewsDatatables extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->minifiedAjax(route('api.new.index'))
            //->dom('Bfrtip')
            ->orderBy(1)
            ->selectStyleSingle()
            ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('tag_name')->title('Tag'),
            Column::make('content')->title('Nội dung'),
    ...
    {
        return 'NewsDatatables_' . date('YmdHis');
    }
}
