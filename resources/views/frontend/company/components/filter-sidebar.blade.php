<div class="filter-container mt-3">
    ...
    {{-- <div class="field-section mb-3">
        ...
        <div class="collapse show" id="fieldCollapse">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="AffiliateMarketing" value="Affiliate Marketing">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="CustomerService" value="Customer Service">
