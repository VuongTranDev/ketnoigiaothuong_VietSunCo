            ...
            <div class="col-lg-8">
                ...
                <div class="company-info">
                    <table class="info-table">
                        ...
                        <tr>
                            <td><strong>Tổng số giao dịch:</strong></td>
                            <td><strong>{{ $totalTransaction}}</strong> giao dịch</td>
                        </tr>
                        <tr>
                            <td><strong>Đã kết nối với:</strong></td>
                            <td><strong>{{ $totalConnect }} </strong>doanh nghiệp</td>
                        </tr>
                    </table>
                </div>
                <hr class="line-w-100">
